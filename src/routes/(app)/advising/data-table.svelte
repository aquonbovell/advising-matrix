...
<div>
	<div class="flex items-center py-4">
		<Input.Root
			...
			onchange={(e) => table.getColumn('studentEmail')?.setFilterValue(e.currentTarget.value)}
			oninput={(e) => table.getColumn('studentEmail')?.setFilterValue(e.currentTarget.value)}
			class="max-w-sm"
		/>
		<DropdownMenu.Root>
