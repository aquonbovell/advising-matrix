<script lang="ts">
	...
	const form = superForm(data, {
		delayMs: 200,
		validators: zodClient(majorSchema),
		dataType: 'json'
	});
	...
	<Form.Field {form} name="requirements">
		<Form.Control let:attrs>
			<div class="flex items-baseline justify-between">
				<Form.Label class="font-semibold">Major Requirements</Form.Label>
