...
<div class="flex h-screen w-full items-center justify-center px-4">
	<Card.Root class="mx-auto min-w-96 max-w-lg	">
		<Card.Header>
			<Card.Title class="text-2xl">Disciplines - Major</Card.Title>
			<Card.Description>Manage this major details</Card.Description>
		</Card.Header>
		<Card.Content>
			<div class="grid gap-4">
				<div class="grid gap-2">
					<Label.Root for="name">Major</Label.Root>
					<Input.Root
						id="name"
						type="text"
						required
				...
				<div class="flex flex-row space-x-1">
					<Button.Root
						type="button"
						href={`/disciplines/majors/edit/${page.params.id}`}
