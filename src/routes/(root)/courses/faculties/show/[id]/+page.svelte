...
<div class="flex h-screen w-full items-center justify-center px-4">
	<Card.Root class="mx-auto min-w-96 max-w-lg	">
		<Card.Header>
			<Card.Title class="text-2xl">Show Faculty</Card.Title>
			<Card.Description>Manage this faculty's details</Card.Description>
		</Card.Header>
		<Card.Content>
			<div class="grid gap-4">
				...
				<div class="flex flex-row space-x-1">
					<Button.Root
						type="button"
						href={`/courses/faculties/edit/${page.params.id}`}
						...
						<AlertDialog.Content>
							<AlertDialog.Header>
								...
								<AlertDialog.Description>
									This action cannot be undone. This will permanently delete the faculty and remove
