<script lang="ts">
	...
	let { data }: { data: SuperValidated<Infer<MinorUpdateSchema>> } = $props();
...
<Card.Root class="mx-auto max-w-lg">
	<Card.Header>
		<Card.Title class="text-2xl">Edit Minor Details</Card.Title>
		<Card.Description
			>Change the minor details below to update a minor for students</Card.Description
		>
	</Card.Header>
	<Card.Content>
					...
					<AlertDialog.Content>
						<AlertDialog.Header>
							...
							<AlertDialog.Description>
								This action cannot be undone. This will permanently change the minor details.
							</AlertDialog.Description>
						</AlertDialog.Header>
						<AlertDialog.Footer>
				...
				<AlertDialog.Root bind:open={isOpenDelete}>
					...
					<AlertDialog.Content>
						<AlertDialog.Header>
							<AlertDialog.Title>Are you absolutely sure?</AlertDialog.Title>
							<AlertDialog.Description>
								This action cannot be undone. This will permanently delete the minor and remove the
